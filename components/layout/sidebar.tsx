            ...
            <div className="space-y-2 px-3 pb-2 pt-2">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-xl bg-neutral-200/50 dark:bg-neutral-800/50 py-2 ps-9 pe-3 text-sm text-black dark:text-white placeholder:text-neutral-400 focus:outline-none focus-visible:outline-none focus:ring-0 border-transparent focus:border-transparent transition-colors hover:bg-neutral-200/80 dark:hover:bg-neutral-800/80"
                    />
                </div>
            </div>
