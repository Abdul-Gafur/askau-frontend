...
- `next-intl` integration for English, French, Portuguese, and Arabic (RTL) support.
- `shadcn/ui` base primitives (buttons, inputs, dialogs, dropdowns).
- Feature-based folder structure setup.
- NextAuth.js integration with Microsoft Entra ID.
