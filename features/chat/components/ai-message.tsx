    ...
    <div className="border-b border-neutral-100 dark:border-neutral-800 py-5 last:border-0">
      ...
      {message.state === "insufficient" && (
        <div className="space-y-4">
          <div className="flex items-start gap-3 rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/40 p-4">
          ...
          <div className="space-y-1.5">
            ...
            {(["refine", "related", "contact", "browse"] as const).map((step) => (
              <button
                key={step}
                type="button"
                className="w-full rounded-xl border border-neutral-200 dark:border-neutral-700 px-4 py-2.5 text-start text-sm text-black dark:text-white transition-colors hover:border-neutral-300 dark:hover:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-900/20"
              >
        ...
        <div className="flex items-start gap-3 rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800/40 p-4">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                className="rounded-lg border border-neutral-200 dark:border-neutral-700 px-3 py-1.5 text-xs text-black dark:text-white transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-800"
              >
      ...
      {message.state === "conflicting" && (
        <div className="space-y-4">
          <div className="flex items-start gap-3 rounded-xl border border-orange-200 dark:border-orange-900/50 bg-orange-50 dark:bg-orange-900/20 p-3">
